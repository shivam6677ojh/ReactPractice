...
//         ))}
//       </div>
//       <p className="font-medium">❤️ {post.reactions.likes} reactions</p>
//       <p className="font-medium"> {post.reactions.dislikes} reactions</p>
//     </div>
//   );
// };
...
const ShowMore = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 space-y-6">
      ...
      <p className="font-medium">❤️ {post.reactions.likes} likes</p>
      <p className="font-medium">👎 {post.reactions.dislikes} dislikes</p>
    </div>
  );
};
